...
//MODULE_DEVICE_TABLE(of, ncp1854_of_match); DEBUG
#endif
...
//    new_client->ext_flag= 0;//DEBUG((new_client->ext_flag ) & I2C_MASK_FLAG ) | I2C_WR_FLAG | I2C_DIRECTION_FLAG;
...
int ncp1854_write_byte(kal_uint8 cmd, kal_uint8 writeData)
{
    ...
    //new_client->ext_flag=0;//DEBUG((new_client->ext_flag ) & I2C_MASK_FLAG ) | I2C_DIRECTION_FLAG;
...
void ncp1854_set_chg_halt(kal_uint32 val)
{
    kal_uint32 ret=0;
